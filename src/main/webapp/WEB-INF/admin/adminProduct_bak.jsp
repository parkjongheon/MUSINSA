...
<nav class="w3-sidebar w3-collapse w3-white " style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="${ctp}/adminProduct.ad" class="w3-bar-item w3-button w3-blue"><i class="fa fa-shopping-bag fa-fw"></i>  상품 관리</a>
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-shopping-cart fa-fw"></i>  주문관리</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <form name="myBrandForm" method="post" action="${ctp}/adPrdBrandInput.ad" enctype="multipart/form-data">
    <h5><b> 브랜드 등록 </b></h5>
  ...
  <!-- 상품 등록 -->
  <div class="w3-container" style="padding-top:22px">
  <form name="myPrdForm" method="post" action="${ctp}/adProductInput.ad" enctype="multipart/form-data">
    <h5><b> 상품 등록 </b></h5>
		    	...
		    	<label for="item">상품명</label>
				  ...
				  <div class="form-group w3-third">
			    	...
			    	<select class="w3-select w3-border w3-round-large" name="optionColor" id="optionColor" style="width: 250px">
						    ...
						    <option value="brown">NAVY</option>	
					  </select>
		    	</div>
				  <div class="form-group w3-third">
