...
<script>
	...
	function productSearch(){
		...
		location.href="${ctp}/adminProductMain.ad?part="+part+"&item="+item+"&pag=${pag}";
...
<nav class="w3-sidebar w3-collapse w3-white " style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="${ctp}/adminProductMain.ad" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-shopping-bag fa-fw"></i>  상품 관리</a>
  ...
  <div class="w3-container">
	  ...
	  <div class="w3-container w3-border p-4 mb-3 w3-round-large">
	  	<p>
	    	...
	    	<input type="button" class="w3-button w3-blue w3-round-large w3-right mb-3" onclick="location.href='${ctp}/adminProduct.ad';" value="상품 등록"/>
	    </p>
